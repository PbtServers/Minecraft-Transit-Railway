...
public final class VehicleResource extends VehicleResourceSchema {
			...
			if (data2 != null) {
				...
				if (data3 != null) {
					...
					if (optimizedModels != null && optimizedModelsDoorsClosed != null && optimizedModelsBogie1 != null && optimizedModelsBogie2 != null) {
						return new VehicleResourceCache(data3.floors, data3.doorways, data3.seats, optimizedModels, optimizedModelsDoorsClosed, optimizedModelsBogie1, optimizedModelsBogie2);
					}
				}
			}
		}
	...
	private CachedResource<CachedResource<CachedResource<VehicleResourceCacheHolder>>> cachedVehicleResourceInitializer(int carNumber, int totalCars, boolean force) {
		...
		return new CachedResource<>(() -> {
			...
			return new CachedResource<>(() -> {
				...
				final ObjectArrayList<Box> seats = new ObjectArrayList<>();
				...
				return new CachedResource<>(() -> {
					...
					return new VehicleResourceCacheHolder(new ObjectImmutableList<>(floors), new ObjectImmutableList<>(doorways), new ObjectImmutableList<>(seats), optimizedModels, optimizedModelsDoorsClosed, optimizedModelsBogie1, optimizedModelsBogie2);
				}, modelLifespan);
			}, modelLifespan);
		}, modelLifespan);
	}
	...
	private static class VehicleResourceCacheHolder {
		...
		private final ObjectImmutableList<Box> seats;
		...
		private VehicleResourceCacheHolder(
				ObjectImmutableList<Box> floors, ObjectImmutableList<Box> doorways, ObjectImmutableList<Box> seats,
