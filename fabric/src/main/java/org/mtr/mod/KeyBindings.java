...
public final class KeyBindings {
	...
	static {
		...
		TRAIN_TOGGLE_SITTING = InitClient.REGISTRY_CLIENT.registerKeyBinding(TranslationProvider.KEY_MTR_TRAIN_TOGGLE_SITTING.key, GLFW.GLFW_KEY_C, TranslationProvider.CATEGORY_MTR_KEYBINDING.key);
	...
	public static final KeyBinding TRAIN_TOGGLE_SITTING;
